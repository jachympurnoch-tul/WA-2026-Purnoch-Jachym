...
class App {
    ...
    public function __construct() {
        ...
        // Příklad: Pokud je URL "game/create", hledá se "GameController.php"
        ...
        // Příklad: Pokud je URL "game/create", hledá se funkce "create()" uvnitř GameControlleru
        if (isset($url[1])) {
        ...
        // 3. PARAMETRY: Vše, co v URL zbylo, se bere jako parametry (např. ID hry)
